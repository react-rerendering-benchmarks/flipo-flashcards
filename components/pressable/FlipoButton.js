...
const FlipoButton = memo(props => {
  return <TouchableOpacity onPress={props.onPress} activeOpacity={0.5} className={`bg-green-dark px-6 py-2 rounded-lg`} style={props.style}>
