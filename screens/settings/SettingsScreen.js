...
const SettingsScreen = ({
  ...
  const themeSettingModal = <FlipoModal title={i18n.t('themeTitle')} visible={true} onButtonPress={useCallback(() => setModal(<></>), [setModal])}>
      <View className='space-y-4'>
        <FlipoText weight='medium' className='text-center
  ...
  const langSettingModal = <FlipoModal title={i18n.t('languageTitle')} visible={true} onButtonPress={useCallback(() => setModal(<></>), [setModal])}>
      <View className='space-y-4'>
        <FlipoText weight='medium' className='text-center
          text-primary dark:text-primary-dark'>
  ...
  return <View className='bg-primary dark:bg-primary-dark min-h-screen'>
      ...
      <TouchableOpacity onPress={() => setModal(themeSettingModal)}>
        <FlipoFlatButton type='setting' title={i18n.t('themeTitle')} value={i18n.t(`${theme}Theme`)} />
      </TouchableOpacity>
      <TouchableOpacity onPress={() => setModal(langSettingModal)}>
        <FlipoFlatButton type='setting' title={i18n.t('languageTitle')} value={i18n.t('language')} />
      </TouchableOpacity>
